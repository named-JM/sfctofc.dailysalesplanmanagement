...
public class UserProfileState : IUserProfileState, IDisposable
{
        ...
        int? employeeId = null)
    {
        ...
        var updatedProfile = _currentValue with
        {
            ...
            EmployeeId = employeeId ?? _currentValue.EmployeeId
        };
    ...
    public void UpdateLocal(string? profilePictureDataUrl = null, string? displayName = null, string? phoneNumber = null, string? timeZoneId = null, string? languageCode = null)
    {
